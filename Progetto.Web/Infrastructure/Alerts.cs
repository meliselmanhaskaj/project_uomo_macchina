...
namespace Progetto.Web.Infrastructure
{
    ...
    public class AlertsAttribute : ActionFilterAttribute
    {
        ...
        {
            var isHistoryBack = context.Result != null && context.Result.GetType().Name == "HistoryContentResult"; // fatto in questo modo per non prendere una dipendenza con codice della funzionalit� History
    ...
    public static class AlertsRazorPageExtensions
    {
        ...
        public static HtmlString RenderAlertsWithToastify(this Microsoft.AspNetCore.Mvc.Razor.RazorPageBase page)
        {
            ...
            else
            {
                ...
                {
                    // Determina la durata: se è 0, disabilita auto-dismiss (-1), altrimenti usa il valore specificato o default 5000ms
