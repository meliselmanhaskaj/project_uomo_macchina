    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<TemplateDbContext>(options =>
            {
                options.UseSqlite(Configuration.GetConnectionString("DefaultConnection"),
                    b => b.MigrationsAssembly("Progetto.Web"));
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                // ROUTING PER AREAS BUONI DIGITALI
                endpoints.MapAreaControllerRoute("Dipendente", "Dipendente", "Dipendente/{controller=Convenzioni}/{action=Index}/{id?}");
                endpoints.MapAreaControllerRoute("Esercente", "Esercente", "Esercente/{controller=Transazioni}/{action=Index}/{id?}");
